...
class ReportingManagerDashboard extends StatefulWidget {
  const ReportingManagerDashboard({super.key});

  @override
  State<ReportingManagerDashboard> createState() => _ReportingManagerDashboardState();
}

class _ReportingManagerDashboardState extends State<ReportingManagerDashboard> {
        ...
        Expanded(
          child: Column(
            ...
            children: [
              ...
              const Text(
                'Good Morning, Reporting Manager',
                style: TextStyle(
                  fontSize: 24,
