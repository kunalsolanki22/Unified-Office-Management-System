...
const navItems = [
    { icon: LayoutDashboard, label: 'Dashboard', path: '/parking/dashboard' },
    { icon: MapPin, label: 'Parking Slots', path: '/parking/slots' },
    { icon: ClipboardList, label: 'Requests', path: '/parking/requests' },
    { icon: CalendarDays, label: 'Holidays', path: '/parking/holidays' },
];
                ...
                <div className="h-[90px] flex items-center justify-between px-5 border-b border-[#f0f0f0]">
                    {!collapsed && (
                        ...
                        >
                            ...
                            <div>
                                <div className="text-[0.75rem] font-extrabold text-[#1a367c] tracking-widest">PARKING</div>
                    ...
                    <div className="flex items-center gap-5">
                        ...
                        <div className="flex items-center gap-3">
                            <div className="text-right">
                                <div className="text-[0.75rem] font-bold text-[#1a367c]">PARKING MANAGER</div>
                                <div className="text-[0.65rem] text-[#f9b012] font-semibold">Slot & Capacity Controls</div>
                            </div>
