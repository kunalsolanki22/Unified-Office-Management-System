                ...
                >
                    ...
                    <div className="relative z-10">
                        ...
                        <div className="text-[2.2rem] font-extrabold text-[#1a367c] leading-tight mb-2 bg-gradient-to-r from-[#1a367c] to-[#2c4a96] bg-clip-text text-transparent">
                            5 Pending<br />Requests
                        </div>
                        <p className="text-[#8892b0] text-[0.95rem] leading-relaxed max-w-[90%]">
                            Review and approve desk allocation requests from employees.
                        </p>
                    </div>
            ...
            <div>
                ...
                <div className="flex flex-wrap justify-center gap-6">
                    {[
                        ...
                        >
                            <div className="absolute inset-0 bg-radial-gradient from-blue-50/50 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
