        ...
        <div className="space-y-6">
            ...
            <div className="bg-white p-8 rounded-[24px] shadow-sm border border-slate-100">
                <div className="flex justify-end mb-6">
                    <button className="bg-[#1a367c] text-white px-5 py-2.5 rounded-xl text-xs font-bold tracking-widest flex items-center gap-2 hover:bg-[#2c4a96] transition-all shadow-md">
                ...
                <div className="overflow-x-auto">
                    <table className="w-full text-left border-collapse">
                        ...
                        <tbody>
                            {[
                                { name: 'Veg Sandwich', cat: 'Snacks', price: '₹120', status: 'Available' },
                                { name: 'Chicken Wrap', cat: 'Main Course', price: '₹180', status: 'Available' },
                                { name: 'Cold Coffee', cat: 'Beverages', price: '₹90', status: 'Out of Stock' }
                            ].map((item, idx) => (
                                <tr key={idx} className="border-b border-slate-50 last:border-0 hover:bg-slate-50/50 transition-colors">
                                    ...
                                    <td className="py-4 px-4 text-right">
                                        <div className="flex items-center justify-end gap-2">
                                            <button className="w-8 h-8 rounded-lg flex items-center justify-center bg-blue-50 text-blue-600 hover:bg-blue-100 transition-colors">
