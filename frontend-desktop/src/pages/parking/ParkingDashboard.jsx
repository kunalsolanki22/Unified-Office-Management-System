...
import { Bell, CalendarDays, MapPin, CheckSquare, ArrowRight, Car, Coffee, Monitor, Users, HardDrive, Loader2 } from 'lucide-react';
...
const ParkingDashboard = () => {
    ...
    const quickActions = [
        { icon: Coffee, label: 'CAFETERIA OPS', sub: 'Food Provisioning Oversight', path: '/parking/service-booking' },
        { icon: Monitor, label: 'DESK MANAGEMENT', sub: 'Workspace Allocation', path: '/parking/service-booking?tab=desk' },
        { icon: Car, label: 'PARKING MANAGER', sub: 'Slot & Capacity Controls', path: '/parking/service-booking?tab=parking' },
        { icon: Users, label: 'CONFERENCE MGMT', sub: 'Room Booking & Scheduling', path: '/parking/service-booking?tab=conference' },
        { icon: HardDrive, label: 'HARDWARE REGISTRY', sub: 'Inventory Assignment', path: '/parking/service-booking?tab=hardware' },
    ];
