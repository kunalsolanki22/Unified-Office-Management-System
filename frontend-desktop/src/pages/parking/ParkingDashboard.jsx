        ...
        <motion.div variants={containerVariants} initial="hidden" animate="visible" className="space-y-8">
            ...
            <div>
                ...
                <div className="flex flex-wrap justify-center gap-6">
                    {[
                        { icon: MapPin, label: 'PARKING SLOTS', sub: 'Floor-wise Slot Availability', path: '/parking/slots' },
                        { icon: CheckSquare, label: 'REQUESTS', sub: 'Review & Approve Employee Requests', path: '/parking/requests' },
                        { icon: CalendarDays, label: 'HOLIDAYS', sub: 'View Company Holiday Calendar', path: '/parking/holidays' },
                    ].map((action, idx) => (
                        <motion.div
                            key={idx}
                            variants={itemVariants}
