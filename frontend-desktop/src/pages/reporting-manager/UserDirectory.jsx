                ...
                <div className="divide-y divide-slate-100 max-h-[600px] overflow-y-auto custom-scrollbar">
                    {loading ? (
                        ...
                        <div className="flex flex-col items-center justify-center py-12 text-red-400 gap-2">
                            ...
                            <button onClick={() => fetchUsers(searchQuery)} className="text-xs font-bold text-[#1e3a8a] hover:underline">Retry</button>
                        </div>
                    ) : users.length > 0 ? (
                        users.map((user) => {
                            ...
                            return (
                                <div key={user.user_code} className="grid grid-cols-[50px_2fr_1.5fr_2fr] gap-4 px-6 py-4 items-center hover:bg-slate-50 transition-colors group">
                                    ...
                                    <div>
                                        <div className="font-bold text-[#1e3a8a] text-sm group-hover:text-[#2c4a96] transition-colors">{fullName}</div>
